...
const PULSE_COLORS: [number, number, number][] = [
  [ 20, 184, 166],  // teal-500    (logo primary)
  [ 20, 184, 166],  // teal-500    (extra weight)
  [ 45, 212, 191],  // teal-400
  [139,  32,  32],  // logo-red    (logo secondary)
  [ 15, 118, 110],  // teal-700
];
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      for (const cell of cells) {
        ...
        ctx.strokeStyle = `rgba(20,184,166,${0.04 + glow * 0.18})`;
    ...
    // Respect prefers-reduced-motion and skip on touch/low-power devices
