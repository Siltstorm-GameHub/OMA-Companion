          ...
          <div style={{
            ...
            <div className="p-1">
              <Link href="/profile" onClick={() => setAvatarOpen(false)}
                className="flex items-center gap-2 w-full px-3 py-2 rounded-lg text-xs text-gray-400 hover:text-teal-400 hover:bg-teal-500/[0.08] transition-colors">
    ...
    <div ref={containerRef}>
      ...
      <button
        ...
        style={{
          ...
          boxShadow:     mobileOpen ? "0 0 24px rgba(20,184,166,0.25), 0 4px 20px rgba(0,0,0,0.5)" : "0 4px 20px rgba(0,0,0,0.5)",
...
function Divider() {
  return (
    <div className="h-6 w-px shrink-0" style={{ background: "rgba(20,184,166,0.10)" }} />
  );
}
...
function NavItem({
  ...
  const activeShadow = danger
    ...
    : "0 0 12px rgba(20,184,166,0.18), inset 0 0 0 1px rgba(20,184,166,0.22)";
