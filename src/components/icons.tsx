...
export const ChevronDown = make("arrow-down");
export const ChevronLeft = make("arrow-prev");
export const ChevronRight = make("arrow-next");
export const ChevronUp = make("arrow-up");
...
export const ImageDown = make("photo");
export const ImagePlus = make("photo");
...
export const LifeBuoy = make("help");
...
export const Move = make("direction");
export const Music = make("music");
export const Newspaper = make("post");
export const Package = make("bag");
...
export const Radio = make("wifi-on");
export const RefreshCw = make("refresh");
export const Repeat = make("reverse");
...
export const SearchX = make("search");
export const Send = make("send");
export const Server = make("globe");
...
export const ShieldAlert = make("defense-weak");
...
export const TrendingDown = make("arrow-down");
export const TrendingUp = make("arrow-up");
...
export const Users = make("user");
export const Users2 = make("user");
export const Vote = make("confirm");
export const Wallet = make("pouch");
export const Wand2 = make("wand-2");
...
export const Heading2 = make("heading");
export const Italic = make("italic");
export const Quote = make("quote");
export const Smartphone = make("smartphone");
export const Square = make("square");
export const ToggleLeft = make("toggle-off");
export const ToggleRight = make("toggle-on");
export const Unlink = make("unlink");
export const UserCheck = make("user-check");
export const UserMinus = make("user-minus");
export const UserX = make("user-x");
