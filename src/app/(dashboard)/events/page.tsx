    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        {events.map((ev) => {
          ...
          // Beschreibung bereinigen (alten discord:-Marker entfernen falls vorhanden)
          ...
          return (
            <div key={ev.id} className="card-hover bg-gray-900 border border-gray-800 rounded-xl p-4 flex items-center gap-4">
              {/* Datum */}
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Discord-Link nach Anmeldung */}
                {isRegistered && discordEventUrl && (
                  <a href={discordEventUrl} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 text-xs text-rose-400 hover:text-rose-300 mt-1.5 transition-colors">
