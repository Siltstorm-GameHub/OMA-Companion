        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className="relative flex flex-col items-center gap-1 flex-1 transition-transform duration-200 ease-out"
            >
              {isActive ? (
                <div
                ...
                >
                  ...
                  {showBadge && (
                    <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-rose-500 text-white text-[10px] font-black flex items-center justify-center border-2 border-[#14171f] shadow-md">
