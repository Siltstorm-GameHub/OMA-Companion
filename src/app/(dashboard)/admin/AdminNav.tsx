...
import {
  ...
  Wrench, Users2, Megaphone, Handshake, Clapperboard, Server, Gamepad2, Sofa, MonitorSmartphone,
} from "lucide-react";
...
const CATEGORIES: {
  ...
  },
  {
    ...
    icon: Wrench,
    minRole: "admin",
    prefixes: ["/admin/notifications", "/admin/badges", "/admin/users", "/admin/minigames", "/admin/zimmer", "/admin/mancave"],
    tabs: [
