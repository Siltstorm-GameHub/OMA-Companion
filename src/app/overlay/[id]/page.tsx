...
const ELEMENT_KEYS: ElementKey[] = ["brand", "ticker", "panel"];
...
export default async function OverlayPage({
  ...
  searchParams: Promise<{ token?: string; panels?: string; rotate?: string; pos?: string; ticker?: string; brand?: string; layout?: string }>;
}) {
  const { id: eventId } = await params;
  const {
    token, panels: panelsParam, rotate: rotateParam, pos: posParam,
    ticker: tickerParam, brand: brandParam, layout: layoutParam,
  } = await searchParams;
