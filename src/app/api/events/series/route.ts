...
export async function POST(req: NextRequest) {
  ...
  const series = await prisma.eventSeries.create({
    data: {
      ...
      placementRewardsJson: placementRewardsJson != null ? JSON.stringify(placementRewardsJson) : null,
      pollsConfigJson: pollsConfigJson != null ? JSON.stringify(pollsConfigJson) : null,
