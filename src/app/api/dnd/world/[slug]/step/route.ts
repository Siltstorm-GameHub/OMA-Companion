 ...
 * gerade abgeschlossen wurde. Der Server prüft nur Ort und Reihenfolge; der Client meldet, was er
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ slug: string }> }) {
  ...
  const result = await advanceWorldQuestStep(card.id, slug, from);
