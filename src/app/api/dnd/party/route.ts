...
import { getInvitesFor, getPartyOf, invite, leave, respond } from "@/lib/dnd/party";
...
export async function GET() {
  ...
  return NextResponse.json({ myCardId: card.id, party: await getPartyOf(card.id), invites: await getInvitesFor(card.id) });
}
