...
const KINDS = {
  ...
  "hero-accessory":      { minRole: "admin",     maxBytes: 2_000_000 }, // Ausrüstungsgrafiken (Helden-Baukasten)
  "hero-base-pose":      { minRole: "admin",     maxBytes: 6_000_000 }, // Ganzkörper-Basis-Posen (Helden-Baukasten)
} as const;
