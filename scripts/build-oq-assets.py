...
FX = {
    ...
    'lightning': ('Pixel Fight FX/Super Pixel Explosion FX Pack 1', 'expfx1_symmetrical_explosion_B_large_yellow'),
    'shadow': ('Pixel Fight FX/Super Pixel Fantasy FX Pack 1', 'fanfx1_skull_puff_large_violet'),
    'nature': ('Pixel Fight FX/Super Pixel Explosion FX Pack 1', 'expfx1_stylized_explosion_A_large_green'),
    'sound': ('Pixel Fight FX/Super Pixel Impact FX Pack 1', 'impfx1_toon_impact_A_large_white'),
